...
#[serde(rename_all = "camelCase", deny_unknown_fields)]
pub struct StorageScanCancelParams {
    pub scan_id: String,
}

#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
pub struct StorageScanCancelResult {
    pub cancelled: bool,
}

pub const CAPABILITY_STORAGE_SCAN_CANCELLATION_V1: &str = "storageScanCancellationV1";
    ...
    fn sample_report() -> StorageReport {
        StorageReport {
            ...
            credentials: CredentialsStatus {
                ...
                keyring_backend: "fixture".into(),
                keyring_providers: Vec::new(),
                plaintext_providers: vec!["fixture".into()],
            },
