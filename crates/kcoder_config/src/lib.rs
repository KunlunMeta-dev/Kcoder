...
mod model_sources;
pub use model_sources::{ModelConfigurationSources, ModelConfigurationFieldSources};
mod loader;
pub use loader::{
    ...
    set_dotted_value, update_scope, update_settings_file, update_settings_and_credentials, user_config_dir,
