...
mod tests {
    ...
    use super::{ThreadManager, ThreadRuntime};
    use crate::app_server::{
        ActiveTurn, ApprovalContext, BackgroundEventPump, BackgroundFollowupScheduler,
        BackgroundFollowupState, BackgroundProjectionState, BackgroundTurnProjection,
    ...
    fn test_runtime(_id: &str, history: &std::path::Path) -> ThreadRuntime {
