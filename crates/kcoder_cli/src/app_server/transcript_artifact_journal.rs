...
impl Kind {
    fn name(self) -> &'static str {
        match self {
            ...
            Self::TurnAdmissions => "turn-admissions",
            Self::TurnAttempts => "turn-attempts",
            Self::TurnContinuations => "turn-continuations",
...
pub(super) fn write<T>(
    ...
    let mut fence = JournalFence::acquire_for_write(&root, JournalDomain::ClientMetadata)?;
