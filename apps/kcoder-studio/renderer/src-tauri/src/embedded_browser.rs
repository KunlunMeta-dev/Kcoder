...
const EMBEDDED_BROWSER_BRIDGE_ADDR_ENV: &str = "KCODER_STUDIO_EMBEDDED_BROWSER_BRIDGE_ADDR";
...
const EMBEDDED_BROWSER_OPEN_REQUEST_EVENT: &str = "kcoder:embedded-browser-open-request";
const EMBEDDED_BROWSER_DOWNLOAD_EVENT: &str = "kcoder:embedded-browser-download";
