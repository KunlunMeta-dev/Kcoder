...
describe('LocalProjectEditDialog', () => {
  ...
  test('uses the device folder picker when the Web client edits project roots', async () => {
    ...
    expect(screen.getByTestId('local-project-folder-picker')).toBeInTheDocument()
