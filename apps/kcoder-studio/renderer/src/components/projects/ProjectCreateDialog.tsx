...
function ProjectCreateDialogContent({
  ...
  const canSelectDeviceTab = (device: DeviceInfo) =>
    ...
    (isDeviceBelowStudioVersion(device) && canRequestDeviceUpgrade(device)) ||
  ...
  const renderActiveDevicePanel = () => {
    ...
    const belowVersion = isDeviceBelowStudioVersion(activeDevice)
                  ...
                  {belowVersion
                    ? t('workbench.project_device_upgrade_detail', {
                        ...
                        current: activeDevice.executor_version
                          ...
                          : '-',
                        required: KCODER_STUDIO_MIN_EXECUTOR_VERSION,
                      })
  ...
  const getDeviceTabStatus = (device: DeviceInfo, linked: boolean) => {
    ...
    if (isDeviceBelowStudioVersion(device)) {
