    ...
    >
      {loading ? (
        ...
        <div className="flex h-full min-h-0 flex-col overflow-hidden">
          ...
          {diffTruncated ? (
            <p
              data-testid="file-changes-review-truncated"
              className="shrink-0 border-b border-border bg-amber-50 px-6 py-2 text-sm text-amber-800"
            >
              {tCommon('workbench.file_changes_review_truncated')}
            </p>
          ) : null}
          <div
