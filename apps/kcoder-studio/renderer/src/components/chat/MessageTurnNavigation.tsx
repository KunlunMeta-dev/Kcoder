  ...
  const handleMarkerClick = useCallback(
    async (marker: MessageTurnMarker) => {
      ...
      if (currentAnchor) {
        ...
        if (gapMarker && onLoadTurnNavigationItem) {
          ...
          try {
            ...
            console.error('[KCoder Studio] Message turn navigation gap load failed', {
      ...
      try {
        ...
        console.error('[KCoder Studio] Message turn navigation marker load failed', {
          markerId: marker.id,
          error,
        })
      }
...
function logTurnNavigation(event: string, details: Record<string, unknown>) {
  console.warn(`[KCoder Studio] Message turn navigation ${event}`, details)
}
