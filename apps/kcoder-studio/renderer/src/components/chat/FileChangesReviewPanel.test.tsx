...
const treeDiff = [
  'diff --git a/renderer/src/components/chat/FileChangesReviewPanel.test.tsx b/renderer/src/components/chat/FileChangesReviewPanel.test.tsx',
  '--- a/renderer/src/components/chat/FileChangesReviewPanel.test.tsx',
  '+++ b/renderer/src/components/chat/FileChangesReviewPanel.test.tsx',
  '@@ -1 +1 @@',
  '-old test',
  '+new test',
  'diff --git a/renderer/src/components/chat/FileChangesReviewPanel.tsx b/renderer/src/components/chat/FileChangesReviewPanel.tsx',
  '--- a/renderer/src/components/chat/FileChangesReviewPanel.tsx',
  '+++ b/renderer/src/components/chat/FileChangesReviewPanel.tsx',
  '@@ -1 +1 @@',
  '-old component',
  '+new component',
  '@@ -20 +20 @@',
  '-old second hunk',
  '+new second hunk',
  'diff --git a/renderer/src/i18n/locales/en/chat.json b/renderer/src/i18n/locales/en/chat.json',
  '--- a/renderer/src/i18n/locales/en/chat.json',
  '+++ b/renderer/src/i18n/locales/en/chat.json',
  '@@ -1 +1 @@',
  '-old english',
  '+new english',
  'diff --git a/renderer/src/i18n/locales/zh-CN/chat.json b/renderer/src/i18n/locales/zh-CN/chat.json',
  '--- a/renderer/src/i18n/locales/zh-CN/chat.json',
  '+++ b/renderer/src/i18n/locales/zh-CN/chat.json',
  '@@ -1 +1 @@',
  '-old chinese',
  '+new chinese',
].join('\n')
