...
import { defaultNewChatModel } from '@/features/workbench/runtimeModelSelection'
...
export function findDefaultModel(models: UnifiedModel[]): UnifiedModel | null {
  return defaultNewChatModel(models)
}
