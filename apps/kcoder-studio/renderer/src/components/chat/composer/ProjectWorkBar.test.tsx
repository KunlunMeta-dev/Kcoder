...
describe('ProjectWorkBar', () => {
  ...
  test('keeps local workspace device details out of the workbar summary', () => {
    ...
    expect(screen.getByTestId('project-work-button')).not.toHaveTextContent('203.0.113.10')
  ...
  test('shows remote mode separately from the project name and right-aligns the remote IP', () => {
    ...
    expect(screen.getByTestId('project-work-remote-status')).toHaveTextContent('203.0.113.10')
  ...
  test('shows the device summary for a single-workspace project row', async () => {
    ...
    expect(option).toHaveTextContent('203.0.113.10')
  ...
  test('selects the saved primary folder for a same-host gateway multi-root project', async () => {
    const onSelectProjectWorkspace = vi.fn()
    ...
    expect(screen.getByTestId('project-option-7')).toHaveTextContent('Wegent')
    expect(screen.getByTestId('project-option-7')).toHaveTextContent('api')
    ...
    expect(onSelectProjectWorkspace).toHaveBeenCalledWith(7, 302)
  })
