...
const TODO_WRITE_TOOLS = new Set(['todowrite', 'todo_write', 'write_todos', 'update_plan'])
const SUBAGENT_TOOLS = new Set(['spawn_agent', 'explore_agent', 'planagent', 'agent', 'agenttool'])
...
export function isTodoWriteToolName(name: string): boolean {
  return matchesToolName(name, TODO_WRITE_TOOLS)
}

export function isSubagentToolName(name: string): boolean {
  return matchesToolName(name, SUBAGENT_TOOLS)
}
