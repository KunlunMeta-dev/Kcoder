  ...
  return (
    <main className="min-w-0 flex-1 overflow-y-auto bg-background text-text-primary">
      ...
      <div className="mx-auto flex w-full max-w-[1040px] flex-col gap-7 px-5 pb-14 pt-5 sm:px-8 sm:py-4">
        ...
        {actionError && (
          <div role="alert" data-testid="plugin-detail-action-error" className="mb-4 flex items-start gap-3 rounded-lg border border-red-200 p-3 text-sm text-red-600">
            <p className="min-w-0 flex-1 break-words">{actionError}</p>
            {onDismissError && <button type="button" data-testid="plugin-detail-dismiss-error" onClick={onDismissError} className="shrink-0 rounded px-2 py-1 focus-visible:ring-2">
