...
const FIELD_CONTROL_CLASS =
  'mt-1 h-10 w-full rounded-xl border border-border bg-background text-text-primary shadow-sm outline-none transition-all duration-150 hover:border-text-muted/30 focus:border-blue-500/60 focus:ring-2 focus:ring-blue-500/15 disabled:cursor-not-allowed disabled:opacity-40 max-md:h-11'
