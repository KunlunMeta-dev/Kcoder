...
export function SettingsSelect({
  ...
  return (
    ...
    >
      ...
      <span
        aria-hidden="true"
        className={`flex items-center text-sm text-text-primary transition-all duration-150 peer-focus-visible:ring-2 peer-focus-visible:ring-blue-500/30 peer-disabled:opacity-40 max-md:min-h-11 ${density === 'compact' ? 'h-7 gap-2 rounded-lg border border-transparent px-2 peer-hover:bg-text-primary/5' : 'min-h-10 gap-3 rounded-xl border px-3 shadow-sm peer-hover:border-text-muted/30'} ${menu ? 'border-blue-500/60 bg-background ring-2 ring-blue-500/10' : density === 'compact' ? 'border-transparent bg-transparent' : 'border-border bg-background'}`}
      >
