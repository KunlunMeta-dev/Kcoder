        ...
        <DesktopTopBar
          ...
          left={
            <button
              ...
              onClick={onBack}
              className="flex h-7 items-center gap-1.5 rounded-lg px-2 text-sm text-text-secondary transition-colors hover:bg-[rgb(var(--color-sidebar-hover))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
            >
            ...
            return (
              <div key={item.key}>
                ...
                <button
                  ...
                  className={[
                    'flex min-h-[30px] w-full items-center gap-2 rounded-[10px] px-2.5 text-left text-sm transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-blue-500',
                    activeNav === item.key
