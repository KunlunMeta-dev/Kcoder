    ...
    >
      <div className="mb-4 flex items-center justify-between gap-4">
        ...
        <Button
          ...
          className="h-8 w-8 focus-visible:ring-blue-500 max-md:h-11 max-md:w-11"
        >
          <X className="h-4 w-4" />
        </Button>
      </div>
      ...
      >
        ...
        <div className="mt-4">
          <Button
            ...
            className="px-2 text-text-secondary focus-visible:ring-blue-500 max-md:h-11"
          >
            ...
            {draft.transport === 'ssh' && (
              <label className="mt-4 flex min-h-9 items-start gap-2 text-sm text-text-secondary max-md:min-h-11">
                <Checkbox
                  ...
                  className="mt-1 h-4 w-4 focus-visible:ring-2 focus-visible:ring-blue-500"
                />
                <span>
        ...
        <div className="mt-5 flex flex-wrap justify-end gap-2">
          ...
          <Button
            ...
            disabled={busy !== null}
            className="min-w-28 focus-visible:ring-blue-500 max-md:h-11"
          >
