...
import { OPEN_TERMINAL_COMMAND, TOGGLE_SIDE_PANEL_COMMAND } from '@/lib/keybindings'
import {
...
export const WorkspacePanelActions = memo(function WorkspacePanelActions({
  ...
  const terminalShortcut = useConfiguredKeybinding(OPEN_TERMINAL_COMMAND)
  const sidePanelShortcut = useConfiguredKeybinding(TOGGLE_SIDE_PANEL_COMMAND)
  ...
  const codeServerEnabled = Boolean(
    workspaceSessionApi &&
    codeServerDevice &&
    supportsCodeServerSessions(codeServerDevice, codeServerProjectDeviceId)
  )
  ...
  const rightPanelTitle = rightPanelOpen
    ? t('workbench.close_right_workspace_panel')
    : t('workbench.toggle_right_workspace_panel')
  ...
  return (
    <>
      ...
      {showPrimaryTarget &&
        ...
        (!codeServerDevice?.capabilities?.includes('kcoder-gateway') || codeServerEnabled) && (
          <button
            type="button"
            data-testid="open-code-server-titlebar-button"
        ...
        <>
          ...
          {showRightPanelToggle && (
            <TitlebarTooltip
              ...
              shortcut={sidePanelShortcut ?? undefined}
              align="end"
            >
              <button
                type="button"
