import { invokeRuntimeCommand as invoke } from '@/kcoder/gatewayServiceBridge'
...
export type BrowserLinkTarget = 'system' | 'studio'
...
const supportedBrowserLinkTargets = new Set<BrowserLinkTarget>(['system', 'studio'])
