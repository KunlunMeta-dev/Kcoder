import {
  invokeRuntimeCommand as invoke,
  subscribeRuntimeEvent as listen,
...
export function requestLocalExecutor<T = unknown>(
  ...
  return invoke<T>(LOCAL_EXECUTOR_COMMANDS.request, { method, params }, options)
}
