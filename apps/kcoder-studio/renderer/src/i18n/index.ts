...
import enSshTerminal from './locales/en/sshTerminal.json'
import zhSshTerminal from './locales/zh-CN/sshTerminal.json'
...
i18n
  ...
  .init({
    ...
    defaultNS: 'common',
    ns: ['common', 'chat', 'localRuntime', 'sites', 'hooks', 'sshTerminal', ...extensionNamespaces],
