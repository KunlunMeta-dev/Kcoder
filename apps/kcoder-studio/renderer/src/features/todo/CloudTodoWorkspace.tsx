        ...
        {externalProvider && (
          <section className="space-y-4 rounded-xl bg-muted/40 p-3">
            ...
            <label className="block text-sm font-medium text-text-primary">
              ...
              <span className="mt-1.5 block text-xs font-normal text-text-muted">
                {location === 'cloud'
                  ? '令牌会加密保存在已连接的服务端，并安全下发给本地 Executor。'
  ...
  useEffect(() => {
    ...
    const refreshItems = () => {
      void selectedProjectApi
        ...
        .catch(error => {
          console.error('[KCoder Studio project board] issue refresh failed', {
        ...
        {sidebarCollapsed && (
          ...
          >
            ...
            <DesktopAppSwitcher
              ...
              testIds={{
                studio: 'cloud-todo-collapsed-app-studio',
