...
export function mergeAppearance(update: AppearanceUpdate): AppearanceConfig {
  ...
  return {
    ...
    terminal: {
      colors: {
        foreground_light: isHexColor(update.terminal?.colors?.foreground_light)
          ? update.terminal.colors.foreground_light
          : null,
        foreground_dark: isHexColor(update.terminal?.colors?.foreground_dark)
          ? update.terminal.colors.foreground_dark
          : null,
      },
    },
    mode: nextMode,
