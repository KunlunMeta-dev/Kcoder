...
import {
  ...
  normalizeRuntimeWorkspacePaths,
...
describe('workbenchRuntimeHelpers', () => {
  ...
  test('drops Windows namespace prefixes from runtime device workspace paths', () => {
    const [normalized] = normalizeRuntimeWorkspacePaths([
      {
        deviceId: 'device-1',
        available: true,
    ...
    expect(normalized.workspacePath).toBe('C:/Users/kunlunmeta/projects/gpt-factory')
  })
