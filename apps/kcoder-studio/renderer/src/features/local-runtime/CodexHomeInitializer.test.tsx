...
describe('CodexHomeInitializer', () => {
  ...
  test('does not prompt or query upstream home migration on a Gateway host', () => {
    ...
    expect(screen.getByTestId('workbench-child')).toBeInTheDocument()
    expect(screen.queryByRole('dialog')).not.toBeInTheDocument()
    expect(localCodexPluginApiMock.codexHomeMigrationStatus).not.toHaveBeenCalled()
    expect(localCodexPluginApiMock.initializeCodexHome).not.toHaveBeenCalled()
  })
