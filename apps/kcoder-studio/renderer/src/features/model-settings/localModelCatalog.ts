...
// The standalone KCoder build keeps instruction assets within Vite's isolated root.
import GPT_DEFAULT_INSTRUCTIONS from '@/assets/gptDefaultInstructions.md?raw'

export type LocalModelCatalogEntry = Record<string, unknown>

export const DEFAULT_CUSTOM_MODEL_BASE_INSTRUCTIONS = GPT_DEFAULT_INSTRUCTIONS
...
export function createDefaultLocalModelCatalogEntry(input: {
  ...
  return {
    ...
    description: 'User-configured KCoder model capability profile',
