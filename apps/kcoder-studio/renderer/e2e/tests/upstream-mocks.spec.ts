...
const sitesUpstreamMockUrl = requiredE2EUrl('KCODER_STUDIO_SITES_UPSTREAM_MOCK_URL')
const connectorUpstreamMockUrl = requiredE2EUrl('KCODER_STUDIO_CONNECTOR_UPSTREAM_MOCK_URL')
  ...
  const initializeResponse = await request.post(`${connectorUpstreamMockUrl}/mcp`, {
    data: {
      ...
      params: {
        ...
        capabilities: {},
        clientInfo: { name: 'studio-e2e', version: '0.1.0' },
      },
    },
  })
