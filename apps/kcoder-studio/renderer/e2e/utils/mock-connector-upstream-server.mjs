...
const PORT = Number.parseInt(process.env.KCODER_STUDIO_CONNECTOR_UPSTREAM_MOCK_PORT || '0', 10)
...
server.listen(PORT, '127.0.0.1', () => {
  ...
  if (!address || typeof address === 'string') throw new Error('Connector mock address unavailable')
  console.log(
    JSON.stringify({ event: 'READY', service: 'connector', host: '127.0.0.1', port: address.port })
  )
})
