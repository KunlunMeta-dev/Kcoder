...
await runE2E(import.meta.url, {
  ...
  const save = async (model, makeDefault, maxOutputTokens) => {
  ...
  const afterB = await save('model-B', false, 2048);
  ...
  return { candidateProbeModels: ['model-A', 'model-B'], sameProviderModelsPersisted: true,
