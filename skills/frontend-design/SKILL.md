...
1. a warm cream background (near #F4F1EA) with a high-contrast serif display and a terracotta or warm-clay accent (often near #D97757 — a common AI-frontend accent, so on a user's brief it can read as a tell);
